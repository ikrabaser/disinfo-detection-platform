...
def main():
    ...
    transform = StructuralFeaturesTransform()
    ...
    print()
    print("=" * 70)
    print("STRUCTURAL MULTI-SEED SONUÇLARI")
    print("=" * 70)
    ...
    output_file = (
        evaluation_dir
        / "structural_multi_seed_summary.json"
    )
